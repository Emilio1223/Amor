...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, Emiro";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2024-12-30T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2026-12-30T00:00:00');
  ...
  function update() {
    ...
    container.innerHTML =
      `Llevamos felizmente enamorados: <b>${days}</b> días<br>` +
